<script lang="ts">
  ...
  let { class: className, header, children, ...restProps }: Props = $props();
</script>
...
<div class="expandable-data-table-frame" data-slot="expandable-data-table-frame">
  <div class="expandable-data-table-scroll" data-slot="expandable-data-table-scroll">
    <table class={className} data-slot="expandable-data-table" {...restProps}>
...
<style>
  @layer blocks {
    ...
    .expandable-data-table-scroll :global(th[data-slot="expandable-data-table-disclosure-header"]) {
      padding-inline-start: calc(var(--space-2) + var(--space-2) + 1.5rem);
    }
  ...
  @layer exceptions {
    .expandable-data-table-scroll :global(th[data-align="end"]) {
      text-align: end;
    }
  }
</style>
