<script lang="ts">
  ...
  export type ExtensionStatus = "supported" | "not-reported" | "unknown" | "client-side" | "unavailable";
...
<Accordion.Item {value} class="lab-extension-item" data-included={included} data-unavailable={status === "unavailable"}>
