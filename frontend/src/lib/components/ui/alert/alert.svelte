  ...
  export const alertVariants = tv({
    ...
    variants: {
      variant: {
        ...
        warning:
          "border-warning-foreground/50 bg-warning-foreground/20 text-warning-foreground *:data-[slot=alert-description]:text-warning-foreground *:[svg]:text-current",
        destructive:
          "border-destructive/50 bg-destructive/20 text-destructive *:data-[slot=alert-description]:text-destructive *:[svg]:text-current",
      },
    },
    defaultVariants: {
      variant: "default",
