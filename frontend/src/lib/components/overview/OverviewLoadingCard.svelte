...
@layer blocks {
  ...
  :global(.overview-loading-icon) { width: 64px; height: 64px; }
  :global(.overview-loading-title) { width: min(18rem, 80%); height: 1.5rem; }
  :global(.overview-loading-heading) { width: min(13rem, 60%); height: 1rem; }
  :global(.overview-loading-subtitle) { width: min(16rem, 65%); height: 0.875rem; }
  :global(.overview-loading-eyebrow) { width: 6rem; height: 0.625rem; }
  :global(.overview-loading-line) { width: 100%; height: 0.75rem; }
  :global(.overview-loading-line-short) { width: 68%; height: 0.75rem; }
  :global(.overview-loading-badge) { width: 4.5rem; height: 1.25rem; }
  :global(.overview-loading-badge-wide) { width: 7rem; height: 1.25rem; }
  :global(.overview-loading-button) { width: 7.5rem; height: 2rem; }
  :global(.overview-loading-icon-button) { width: 2rem; height: 2rem; }
  :global(.overview-loading-signal-title) { width: 7rem; height: 0.875rem; }
  :global(.overview-loading-table-heading) { width: 5rem; height: 0.75rem; }
  :global(.overview-loading-table-cell) { width: 80%; height: 0.875rem; }
  :global(.overview-loading-raw-meta) { width: 9rem; height: 0.625rem; }
