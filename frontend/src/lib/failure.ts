...
const CODE_MESSAGES: Record<Exclude<Code, Code.$zero>, Message> = {
  ...
  [Code.CodeWebAuthnExtensionInputInvalid]: m.failure_webauthn_extension_input_invalid,
  [Code.CodeWebAuthnExtensionConflict]: m.failure_webauthn_extension_conflict,
  [Code.CodeWebAuthnSecretSaltLengthInvalid]: m.failure_webauthn_secret_salt_length_invalid,
  [Code.CodeWebAuthnPRFEvaluationInvalid]: m.failure_webauthn_prf_evaluation_invalid,
