...
Product and workbench components live under `frontend/src/components/`; screens live under `frontend/src/screens/`. Screens compose product/workbench components and should not call generated Wails bindings directly. App state, controllers, typed result extractors, and operation handling stay under `frontend/src/lib/`.
